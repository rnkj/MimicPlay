...
from model.utils.net_utils import vis_detections_filtered_objects_PIL, calculate_center
...
if __name__ == "__main__":
    ...
    with h5py.File(new_hdf_path, "w") as hdf:
            ...
            for front_image_index in [1, 2]:
                ...
                with torch.no_grad():
                    ...
                    if front_image_index == 1:
                        ...
                        demo_group.create_dataset("hand_loc", data=all_hand_loc)
        ...
        # save attributes
        hdf.attrs["camera_view1"] = "front"
        hdf.attrs["camera_view2"] = "side"
        hdf.attrs["camera_height"] = img_height
        hdf.attrs["camera_width"] = img_width
